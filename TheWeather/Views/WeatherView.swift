        ...
        VStack (alignment: .center){
            VStack (){
                HStack (){
                    ...
                    RecordBoxView(recordImage: "Humidity", recordValue: String(format: "%.1f", myData.humidity_record), recordTown: myData.humidity_record_town)
                }
            }
            VStack (){
                HStack (){
                    RecordBoxView(recordImage: "Rain", recordValue: String(format: "%.1f", myData.rain_record), recordTown: myData.rain_record_town)
